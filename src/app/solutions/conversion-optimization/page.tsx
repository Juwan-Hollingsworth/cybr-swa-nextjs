...
export const metadata: Metadata = {
  title: 'Conversion Optimization - NextSaaS',
};
  ...
  return (
    <Fragment>
      ...
      <main className="bg-background-3 dark:bg-background-7">
        <PageHero title="Conversion Optimization" heading="Conversion Optimization" link="/solutions/conversion-optimization" />
        <Contents slug="marketing-automation" />
        <CTAV1
