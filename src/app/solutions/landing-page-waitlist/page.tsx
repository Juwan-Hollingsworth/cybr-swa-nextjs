...
export const metadata: Metadata = {
  title: 'Landing Page + Waitlist - NextSaaS',
};
  ...
  return (
    <Fragment>
      ...
      <main className="bg-background-3 dark:bg-background-7">
        <PageHero title="Landing Page + Waitlist" heading="Landing Page + Waitlist" link="/solutions/landing-page-waitlist" />
        <Contents slug="payment-solutions" />
        <CTAV1
