...
export const metadata: Metadata = {
  title: 'Operations Dashboard - NextSaaS',
};
  ...
  return (
    <Fragment>
      ...
      <main className="bg-background-3 dark:bg-background-7">
        <PageHero title="Operations Dashboard" heading="Operations Dashboard" link="/solutions/operations-dashboard" />
        <Contents slug="instantaneous-data-insights-and-analytics" />
        <CTAV1
