...
export const metadata: Metadata = {
  title: 'Product UX Review - NextSaaS',
};

const ProductUxReview = () => {
  return (
    <Fragment>
      <NavbarOne
      ...
      <main className="bg-background-3 dark:bg-background-7">
        <PageHero title="Product UX Review" heading="Product UX Review" link="/solutions/product-ux-review" />
        <Contents slug="business-analysis" />
        <CTAV1
...
export default ProductUxReview;