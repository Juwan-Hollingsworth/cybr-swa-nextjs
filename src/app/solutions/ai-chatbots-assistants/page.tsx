...
export const metadata: Metadata = {
  title: 'AI Chatbots & Assistants - NextSaaS',
};
  ...
  return (
    <Fragment>
      ...
      <main className="bg-background-3 dark:bg-background-7">
        <PageHero title="AI Chatbots & Assistants" heading="AI Chatbots & Assistants" link="/solutions/ai-chatbots-assistants" />
        <Contents slug="cryptocurrency-lending" />
        <CTAV1
