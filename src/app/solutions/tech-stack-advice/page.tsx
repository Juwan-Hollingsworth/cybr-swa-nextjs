...
export const metadata: Metadata = {
  title: 'Tech Stack Advice - NextSaaS',
};

const TechStackAdvice = () => {
  return (
    <Fragment>
      <NavbarOne
      ...
      <main className="bg-background-3 dark:bg-background-7">
        <PageHero title="Tech Stack Advice" heading="Tech Stack Advice" link="/solutions/tech-stack-advice" />
        <Contents slug="track-conversions" />
        <CTAV1
...
export default TechStackAdvice;