...
export const metadata: Metadata = {
  title: 'Feature Development - NextSaaS',
};
  ...
  return (
    <Fragment>
      ...
      <main className="bg-background-3 dark:bg-background-7">
        <PageHero title="Feature Development" heading="Feature Development" link="/solutions/feature-development" />
        <Contents slug="machine-learning-and-ai" />
        <CTAV1
